...
function [indexoutput,cadoutput,speedoutput,stridelenoutput,numofsteps,flag] = walkingparameteranalysis(input,para,walksection,samplerate,path)
...
for jj = 1:length(cadoutput)
    if cadoutput(jj)<0 || speedoutput(jj)<0.0
        ;
    else        
