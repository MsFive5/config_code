%%
function [para,trainingsection,vector1,vector2] = getWalkingPara(input,trainingsection,sensorinfo,samplerate,datapath)
...
%         trainingsection(n).speed = str2num(boutlength)*0.3048/time;
        trainingsection(n).speed = str2num(boutlength)/time; % the input for imagene and merrill data is meter instead of foot
